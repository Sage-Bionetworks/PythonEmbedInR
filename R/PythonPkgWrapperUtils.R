...
#'
#' This function generate R docs from python docs and saves the doc files to the target dir <srcRootDir>/auto-man
#'
#' @param srcRootDir is the root directory for the code base (i.e., prior to installation)
#' @param functionInfo list of function to generate docs
#' @param classInfo list of class to generate docs
